...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "enable_first_party_auth_v2_on_get_account_menu": true,
        ...
        "enable_ips_gating": true,
        "enable_isk_gating": true,
        ...
        "rfa_demotion_inline_ux_change": true,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20241010.09.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en",
            "gl": "EG",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20241010.09.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/fd504f58\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/fd504f58\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}